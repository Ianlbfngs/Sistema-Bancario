...
CREATE TABLE `credentials` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `credentialscol_UNIQUE` (`dni_client`),
  UNIQUE KEY `credentialscol1_UNIQUE` (`user`)
...
INSERT INTO `credentials` VALUES (0,'00000000','admin','admin',1);
...
-- Dump completed on 2025-05-14 18:53:12
